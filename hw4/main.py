...
def train(env, 
    ...
    args.remove('env') # These are not JSON serializable
    args.remove('cost_fn') # These are not JSON serializable
    args.remove('activation') # These are not JSON serializable
    locals_ = locals()
    ...
    for itr in range(onpol_iters):
        ...
        trajectories = sample(env, mpc_controller, num_paths=num_paths_onpol, horizon=env_horizon)
